  ...
  return (
    <div className="max-w-4xl mx-auto py-8">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="bg-blue-50 dark:bg-blue-800/20 border border-blue-200 rounded-md p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white  dark:bg-gray-800 shadow-md rounded-lg p-6">
          ...
          <p className="text-gray-600">
            Activity data would be displayed here, pulled from PayloadCMS.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
          ...
          <p className="text-gray-600">
            User settings would be displayed here, with data stored in PayloadCMS.
          </p>
        </div>
      </div>
    </div>
